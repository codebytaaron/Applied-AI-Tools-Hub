# Renewal + Churn Forecaster

Flags at-risk accounts and suggests save plays based on signals.

## What it does
Given customer health signals, outputs risk tiering, reasons, and a retention action plan.
