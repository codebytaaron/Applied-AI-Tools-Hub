...
Summarizes user access lists, flags risky permissions, and drafts remediation steps.

## What it does
Given access exports, outputs high-risk findings, least-privilege recommendations, and a cleanup plan.
