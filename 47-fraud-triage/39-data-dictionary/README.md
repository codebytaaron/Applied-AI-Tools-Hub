...
Creates a data dictionary and definition standards from field lists and examples.

## What it does
Given fields and examples, outputs definitions, types, allowed values, and validation rules.
