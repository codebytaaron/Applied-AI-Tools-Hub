...
Designs service-level targets and alerting rules for an internal or external service.

## What it does
Given service context, outputs SLA/SLO definitions, error budgets, and alert thresholds.
